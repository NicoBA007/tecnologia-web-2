<x-layout title="Ejercicio 2 - A2">
  <div class="max-w-4xl mx-auto py-20 px-4">
    <h1 class="text-4xl font-bold text-text-beige mb-2">Ejercicio 2</h1>
    ...
    <div class="bg-base-superficie border border-base-borde rounded p-8">
      <p class="text-text-arena">Contenido del ejercicio 2 en desarrollo...</p>
    </div>
